...
def start_client(i, timed, nbr_clients, directory_name,nbr_rounds,X_train,y_train, X_test, y_test):
    from Model.model_JS import create_model_JS
...
""" 
    So the issue is with how the data were given ??
    but with how it is now each client is obligated to load the fullset
    of data, which will make the programm slower, not really an issue for 
    some dataset but will be for CIC-IDS2017
"""
